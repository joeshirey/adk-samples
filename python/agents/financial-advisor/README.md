...
*   **Multi-Agent System**: The agent is composed of a coordinator agent and four sub-agents, demonstrating a hierarchical agent architecture.
...
*   **Built-in Tools**: The `data_analyst` sub-agent uses the built-in `google_search` tool.
